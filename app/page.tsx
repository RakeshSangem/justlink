...
export default function Home() {
  return (
    <main className="w-screen h-screen max-w-7xl mx-auto">
      <Navbar />
      <section className="flex flex-col bg-gradient-to-b from-[#D4D4D4]/10 max-w-5xl to to-[#D4D4D4]/0 items-center justify-center sm:w-5/6 mx-auto py-40 rounded-[40px]">
